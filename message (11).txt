...
Converted["_Night Hub"].Font = Enum.Font.SourceSansBold
Converted["_Night Hub"].Text = "Night Hub Bounty Shit Hunt"
Converted["_Night Hub"].TextColor3 = Color3.fromRGB(255, 255, 255)
Converted["_Night Hub"].TextSize = 14
Converted["_Night Hub"].BackgroundColor3 = Color3.fromRGB(0, 0, 0)
Converted["_Night Hub"].BorderColor3 = Color3.fromRGB(0, 0, 0)
Converted["_Night Hub"].BorderSizePixel = 0
Converted["_Night Hub"].Position = UDim2.new(0.255528241, 0, 0.0250000004, 0)
Converted["_Night Hub"].Size = UDim2.new(0, 198, 0, 40)
Converted["_Night Hub"].Name = "Night Hub"
Converted["_Night Hub"].Parent = Converted["_Frame"]

Converted["_UICorner2"].Parent = Converted["_Night Hub"]
